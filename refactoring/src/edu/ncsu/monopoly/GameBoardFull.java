...
public class GameBoardFull extends GameBoard {
    public GameBoardFull() {
        ...
        IOwanable cc1 = new CardCell(Card.TYPE_CC, "Community Chest 1");
        ...
        IOwanable c1 = new CardCell(Card.TYPE_CHANCE, "Chance 1");
        ...
        IOwanable cc2 = new CardCell(Card.TYPE_CC, "Community Chest 2");
        ...
        IOwanable c2 = new CardCell(Card.TYPE_CHANCE, "Chance 2");
        ...
        IOwanable cc3 = new CardCell(Card.TYPE_CC, "Community Chest 3");
        PropertyCell g3 = new PropertyCell();
        RailRoadCell rr4 = new RailRoadCell();
        IOwanable c3 = new CardCell(Card.TYPE_CHANCE, "Chance 3");
